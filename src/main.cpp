...
uint256 hashGenesisBlock("0x22fc8f7f24487f6f10040e593eec01f6d648bd9902bedaa40e24ac5fcc3f5bee");
...
const string strMessageMagic = "eDollar Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight > 5000) // no block reward after 5 years
        nSubsidy = 100;
...
static const int64 nTargetTimespan = 1.7 * 24 * 60 * 60; // eDollar: 0.5 days
static const int64 nTargetSpacing = 30; // eDollar: 30 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal eDollar miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "eDollar", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "made by JohnDorien 2013/05/27";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x449ebb4f730234e4b9a11fba039c3acc8119be015706782f0f2f13a1fc479ad9"));
